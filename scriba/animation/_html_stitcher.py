...
def _safe_narration_html(value: object) -> str:
    ...
    The isinstance assertion documents and enforces the scriba-internal-only
    contract at runtime.  If ``narration_html`` is ever set to a non-str object
    it indicates a bug in the calling code, not a user-input path.
    """
    assert isinstance(value, str), (  # noqa: S101 — contract assertion, not user-input guard
