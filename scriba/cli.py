...
Usage:
    scriba input.tex              # -> output to input.html
    scriba input.tex -o out.html  # -> output to out.html
    scriba input.tex --open       # -> render and open in browser
    scriba input.tex --static     # -> legacy filmstrip mode
"""
...
def main() -> None:
    """Entry point for the ``scriba`` console script."""
