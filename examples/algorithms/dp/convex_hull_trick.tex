...
\annotate{dp.cell[2]}{label="$L_0(3)=0$", arrow_from="dp.cell[0]", color=muted}
\annotate{dp.cell[2]}{label="$L_1(3)=-4$ win", arrow_from="dp.cell[1]", color=good}
...
\annotate{dp.cell[3]}{label="$L_2(4)=-10$ win", arrow_from="dp.cell[2]", color=good}
