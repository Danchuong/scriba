...
\annotate{G.node[B]}{label="d+1", arrow_from="G.node[A]", color=good}
...
\annotate{G.node[C]}{label="d+1", arrow_from="G.node[A]", color=good}
...
\annotate{G.node[D]}{label="d+1", arrow_from="G.node[B]", color=good}
