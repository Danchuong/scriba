...
\shape{g}{Graph}{nodes=[1,2,3,4,5,6], edges=[(1,2),(2,3),(3,1),(4,5),(5,6),(6,4)], directed=true, layout="force", layout_seed=7}
...
\annotate{lift.cell[1][0]}{label="lift[0][2]", arrow_from="lift.cell[0][1]", color=info}
\annotate{lift.cell[1][3]}{label="lift[0][5]", arrow_from="lift.cell[0][4]", color=info}
...
\annotate{lift.cell[2][0]}{label="lift[1][3]", arrow_from="lift.cell[1][2]", color=info}
\annotate{lift.cell[2][3]}{label="lift[1][6]", arrow_from="lift.cell[1][5]", color=info}
...
\step
\recolor{g.node[1]}{state=current}
\recolor{g.edge[(1,2)]}{state=path}
\recolor{g.node[2]}{state=path}
\highlight{g.node[3]}
\narrate{Bước $1$: dịch chuyển từ $1$ đến $2$. Chưa đến $3$. Tiếp tục.}

\step
\recolor{g.node[1]}{state=path}
\recolor{g.edge[(2,3)]}{state=path}
\recolor{g.node[2]}{state=path}
