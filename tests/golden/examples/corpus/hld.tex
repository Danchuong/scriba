...
\annotate{T.node[2]}{label="heavy", arrow_from="T.node[1]", color=good}
\annotate{T.node[5]}{label="heavy", arrow_from="T.node[2]", color=good}
...
\annotate{T.node[3]}{label="light", arrow_from="T.node[1]", color=info}
\annotate{T.node[6]}{label="heavy", arrow_from="T.node[3]", color=good}
