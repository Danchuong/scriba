...
\apply{plot}{n=7}
\narrate{Bắt đầu với $n = 7$. Dãy số bắt đầu. $7$ là số lẻ, nên ta tính $3 \cdot 7 + 1 = 22$.}
...
\apply{plot}{n=11}
\narrate{$n = 11$. Lẻ, nên $3 \cdot 11 + 1 = 34$.}
...
\apply{plot}{n=17}
\narrate{$n = 17$. Lẻ, $3 \cdot 17 + 1 = 52$. Giá trị nhảy vọt lên -- dãy Collatz thật khó đoán!}
...
\apply{plot}{n=13}
\narrate{$n = 13$. Lẻ, $3 \cdot 13 + 1 = 40$. Lại một lần nhảy vọt do quy tắc số lẻ.}
...
\apply{plot}{n=5}
\narrate{$n = 5$. Lẻ, $3 \cdot 5 + 1 = 16$. Đỉnh nhọn cuối cùng, nhưng $16$ là lũy thừa của $2$ -- nó sẽ chia đôi liên tục xuống $1$!}
