...
deferred. Unlike [`06-out-of-scope.md`](06-out-of-scope.md) — which records
...
authoritative file ([`01-architecture.md`](01-architecture.md),
[`02-tex-plugin.md`](02-tex-plugin.md),
[`04-environments-spec.md`](04-environments-spec.md), or a new contract
