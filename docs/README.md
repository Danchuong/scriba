> **Scriba v0.25.0** — 3 renderers (TexRenderer, AnimationRenderer, DiagramRenderer), 20 primitive types, zero-JS output.
...
| [`primitives.md`](spec/primitives.md) | Primitive catalog — all 20 primitive types (6 base, 6 extended, 8 data-structure). |
