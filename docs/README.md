> **Scriba v0.24.0** — 3 renderers (TexRenderer, AnimationRenderer, DiagramRenderer), 19 primitive types, zero-JS output.
...
| [`primitives.md`](spec/primitives.md) | Primitive catalog — all 19 primitive types (6 base, 6 extended, 7 data-structure). |
